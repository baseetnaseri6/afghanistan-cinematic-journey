...
function displayName(name: string) {
  if (name === "Sari Pul") return "Sar-e Pol";
  if (name === "Sar-i-Pul") return "Sar-e Pol";
  if (name === "Sar-i Pul") return "Sar-e Pol";
  if (name === "Paktya") return "Paktia";
  if (name === "Hirat") return "Herat";
  if (name === "Panjshayr") return "Panjshir";
  if (name === "Nimruz") return "Nimroz";
  if (name === "Hilmand") return "Helmand";
  if (name === "Jawzjan") return "Jowzjan";
  return name;
}
